  ...
  <section
    class="bg-gray-50 dark:bg-gray-900 h-screen flex items-center justify-center overflow-y-auto"
  >
    <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-6 mx-auto w-4/5">
      <!-- Title -->
      <h1
        class="text-2xl tracking-tight font-bold text-gray-900 dark:text-white mb-4"
      >
        Role Management
      </h1>

      <!-- Create New Role Button -->
      <button v-if="hasPermission('create role')" @click="showCreateRoleModal = true"
            ...
            <tbody>
              ...
              >
                ...
                <td class="py-4 px-6 flex space-x-4">
                  <button v-if="hasPermission('edit role')" @click="editRole(role)"
                    class="text-gray-800 hover:text-gray-900 dark:text-white dark:hover:text-gray-300"
                  >
                    <svg
                  ...
                  <button v-if="hasPermission('delete role')" @click="deleteRole(role.id)"
                    class="text-gray-800 hover:text-gray-900 dark:text-white dark:hover:text-gray-300"
                  >
                    <svg
      ...
      <div class="flex justify-between mt-4">
        <button
          ...
          class="bg-gray-300 text-gray-700 rounded-lg px-4 py-2"
        >
          Previous
        </button>
      ...
      <div
        ...
        class="fixed top-0 left-0 right-0 z-50 w-full h-full flex items-center justify-center bg-gray-900 bg-opacity-50"
      >
        <div class="relative w-full max-w-md p-4">
          <div class="bg-white rounded-lg shadow dark:bg-gray-800">
            <div
              class="flex justify-between items-start p-4 border-b rounded-t dark:border-gray-700"
            >
              ...
              <button
                ...
                class="text-gray-400 hover:bg-gray-200 hover:text-gray-900 rounded-lg p-1.5 ml-auto dark:hover:bg-gray-600 dark:hover:text-white"
              >
                ×
              </button>
            </div>
              ...
              <form @submit.prevent="createRole">
                <div class="space-y-4">
                  ...
                  <div>
                    ...
                    >
                      <input v-if="hasPermission('assign permissions')" type="checkbox"
                        :value="permission.id"
                ...
                <div class="flex justify-end pt-4">
                  <button v-if="hasPermission('create role')" type="submit"
          ...
          <div class="bg-white rounded-lg shadow dark:bg-gray-800">
            ...
            <div class="p-6 space-y-4">
              <form @submit.prevent="updateRole">
                <div class="space-y-4">
                  ...
                  <div>
                    ...
                    <div
                      ...
                      class="flex items-center mb-2"
                    >
                      <input v-if="hasPermission('assign permissions')"
                        type="checkbox"
                        :value="permission.id"
                ...
                <div class="flex justify-end pt-4">
                  <button v-if="hasPermission('edit role')" type="submit"
