    ...
    methods: {
        async login() {
            ...
            try {
                ...
                EventBus.emit('adminUserLoggedIn'); // Emit a specific event for admin login
                this.$router.push({ name: 'Admin_home' }); // Redirect to Home page
            } catch (error) {
                if (error.response) {
